...
public class CoinMarketCapController {
  ...
  private String key = "b54bcf4d-1bca-4e8e-9a24-22ff2c3d462c";

  public CoinMarketCapController(MessageChannel channel){
    ...
    try {
      ...
      new MessageBuilder(result, SetType.DESCRIPTION).sendMessage(channel);
    } catch (IOException e) {
