package com.jusjus.includes.components.message;
...
public class MessageBuilder {
    ...
    public MessageBuilder(String message, SetType setType){
        ...
        }else if (setType == SetType.DESCRIPTION){
            this.eb.setDescription(message);
        }
        this.eb.setColor(Color.GREEN);
    }
    ...
    public void sendMessage(MessageChannel channel, Consumer<Message> onSuccess){
        channel.sendMessageEmbeds(this.build()).queue(onSuccess);
    }
