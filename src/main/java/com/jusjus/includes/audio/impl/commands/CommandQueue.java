...
public class CommandQueue extends DiscordCommand {

  private final AudioController audioController;

  public CommandQueue(AudioController audioController, CommandManager commandManager){
  ...
  public void execute(Member member, MessageChannel channel, Message message, String rawContent,
    ...
    switch (args[0]){
      case "list":
        ...
        break;
      case "shuffle":
        if (this.audioController.getAudioTracker().shuffleQueue()){
